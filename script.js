...
// --- ARRANQUE SEGURO (CAMBIO IMPORTANTE AQUÍ) ---
// Usamos 'load' en vez de 'DOMContentLoaded' para asegurar que cargador.js esté listo
window.addEventListener('load', () => {
    // Pequeño timeout de seguridad de 50ms para dar prioridad al renderizado
...
function iniciarTodo() {
    ...
    setupEventListeners();
    // Iniciar listeners de diagnóstico (sin afectar la carga visual)
    setupDiagnosis();
}
...
function renderAvatarSelection(containerId, context) {
    ...
    // Verificar si profileImages existe (desde cargador.js)
...
function loadUserDataInUI() {
    ...
    // IMPORTANTE: Asegurar que el UI de VIP se actualice
...
function setupDiagnosis() {
    // BOTÓN 1: Verificar Contenido (Películas y Caps)
    const btnContent = document.getElementById('btnVerifyContent');
    // BOTÓN 2: Verificar Tráilers
