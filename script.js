...
function renderHero() {
    ...
    // OPTIMIZACIÓN IMAGEN HERO:
    // La primera imagen se carga normal ('eager'), las demás 'lazy'
    // decoding="async" ayuda a que la UI no se trabe mientras carga
...
function createItemHTML(item) {
    ...
    // OPTIMIZACIÓN: decoding="async" en todas las portadas
    return `
...
// ==========================================
// SISTEMA DE DIAGNÓSTICO DE ENLACES (OPTIMIZADO POR LOTES)
// ==========================================
