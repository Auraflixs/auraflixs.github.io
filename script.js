...
function renderHomeView() {
    ...
    // CAMBIO SOLICITADO: Mostrar 30 elementos (3 filas x 10 columnas)
    renderList('homeMoviesRow', moviesShuffled.slice(0, 30));
    renderList('homeSeriesRow', seriesShuffled.slice(0, 30));
}
...
function openModal(id, type) {
    // CAMBIO SOLICITADO: Cerrar el buscador si está abierto para que se vea el modal
    document.getElementById('searchOverlay').style.display = 'none';
    ...
    // Búsqueda robusta (busca en la lista específica y luego en la global por seguridad)
...
function setupEventListeners() {
    ...
    document.getElementById('searchInput').oninput = (e) => {
        ...
        // NOTA: createItemHTML ya incluye la función onclick="openModal..."
