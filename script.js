...
let touchStartX = 0;
let touchEndX = 0;
let vipInterval; // Variable para el reloj VIP
...
// Normalizar texto para búsquedas y filtros
...
function iniciarTodo() {
    ...
    // Iniciar verificación visual del VIP
...
function renderEpisodes(season, serieItem, autoPlayIndex = -1) {
    ...
    // Si hay un capítulo preseleccionado
...
// =========================================================
// FUNCIÓN BLOQUEO VIP (CORREGIDA PARA TRANSPARENCIA)
// =========================================================
function showVipBlocker() {
    const playerDiv = document.getElementById('modalContentPlayer');
    // Usamos la imagen del item como fondo para que la transparencia se note
