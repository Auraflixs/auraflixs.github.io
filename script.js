...
// --- MODAL (CON CORRECCIÓN DE BUG RECOMENDADOS) ---
function openModal(id, type) {
    // Cerrar cualquier overlay abierto
    document.getElementById('searchOverlay').style.display = 'none';
    document.getElementById('historyOverlay').style.display = 'none';

    // CAMBIO: Si el modal ya está abierto (click en recomendado), NO agregamos otro estado al historial.
    // Esto asegura que al dar atrás una sola vez, se cierre el modal.
    ...
    // Resetear scroll del contenido del modal
