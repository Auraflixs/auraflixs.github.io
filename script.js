...
function iniciarTodo() {
    ...
    // Iniciar burbuja un momento después para asegurar que el navegador ya dibujó los botones
...
function updateNavIndicator() {
    ...
    if (activeItem && indicator) {
        ...
        const bubbleWidth = Math.min(itemRect.width * 0.75, 70); 
        indicator.style.width = `${bubbleWidth}px`; 
        
        // Calculamos el centro exacto de la pestaña tocada
...
function switchView(viewName, pushToHistory = true) {
    ...
    // Mover la animación de la gota a la pestaña correcta
