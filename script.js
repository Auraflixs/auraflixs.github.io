...
function setPlayerVideo(url, overlayText = null, isBlocked = false) {
    ...
    if (isDirectFile) {
        ...
        video.onerror = () => {
            playerDiv.innerHTML = '<div style="position:relative; width:100%; padding-top:56.25%; background:#000; display:flex; align-items:center; justify-content:center;"><div style="position:absolute; top:50%; left:50%; transform:translate(-50%, -50%); text-align:center; width:90%;"><p style="margin-bottom:15px; font-size:0.9rem;">Formato no compatible</p></div></div>';
        };
