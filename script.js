...
function setPlayerVideo(url, overlayText = null, isBlocked = false) {
    ...
    if (isDirectFile) {
        ...
        // Cero rastro de sandbox ni restricciones aquí
    ...
    // CAMBIO IMPORTANTE: Solo agregamos el texto superpuesto si es un video directo.
    // Streamtape y otros servidores odian que haya elementos HTML superpuestos en su iframe.
