...
// AQUÍ AGREGUÉ LA CLASE .img-loader PARA LA ANIMACIÓN
...
function openModal(id, typeHint, fromDeepLink = false) {
    ...
    if (isSeries) {
        ...
        // Verificamos si la película está desbloqueada
        ...
        // CORRECCIÓN HISTORIAL: Solo guardar la película si ESTÁ DESBLOQUEADA
        if (hasAccess) {
...
function renderEpisodes(season, serieItem, autoPlayIndex = -1) {
    ...
    if (autoPlayIndex >= 0 && season.episodes[autoPlayIndex]) {
        ...
        // CORRECCIÓN HISTORIAL: Solo guardar el episodio si ESTÁ DESBLOQUEADO
        if (hasAccess) {
...
function setupEventListeners() {
    ...
    // RESTAURADOS EVENTOS DE COMPARTIR
