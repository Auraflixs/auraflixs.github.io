        ...
        if (currentPlayerProgressKey && !window.__auraHasSeeked) { 
            ...
            if (savedTime > 0) {
                if (isReady || hasMetadata || (currentTime !== undefined && currentTime >= 0)) { 
                    ...
                    setTimeout(performSeek, hasMetadata ? 300 : 800);

                    setTimeout(() => {
                        if (window.__auraCurrentPlayerTime !== undefined && window.__auraCurrentPlayerTime < savedTime - 5) {
                            if (window.__auraSeekAttempts < 3) {
                                window.__auraSeekAttempts++;
                                window.__auraHasSeeked = false; 
                            }
                        }
                    }, 3500);
