...
function openModal(id, typeHint) {
    ...
    // Compartir siempre genera link normal (sin VIP)
    if (shareBtn) {
        shareBtn.onclick = () => {
...
window.redirectToVipProfile = function() {
    ...
    if (currentModalItem) {
        ...
        if (shortLink) {
            if (confirm("Este contenido está bloqueado 🔒\n\nPuedes desbloquearlo y verlo ahora mismo accediendo al siguiente enlace.\n\n¿Deseas ir al enlace para desbloquearlo?")) {
