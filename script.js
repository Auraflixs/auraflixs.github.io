...
// ==========================================
// LÓGICA LIQUID GLASS INDICATOR (BURBUJA) - ACTUALIZADA
// ==========================================
function updateNavIndicator() {
    ...
    if (activeItem && indicator) {
        // Obtenemos el ancho del botón activo
        ...
        // Posición central exacta (offsetTop/offsetLeft se adaptan al nuevo contenedor flotante)
...
function switchView(viewName, pushToHistory = true) {
    ...
    // Oculta todas primero quitándoles la clase de animación
    Object.values(views).forEach(v => {
        v.classList.add('hidden');
        // Pequeño truco para forzar el reinicio de la animación
