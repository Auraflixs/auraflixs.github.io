...
// =========================================================
// 🔥 AQUÍ EMPIEZAN LOS CAMBIOS PRINCIPALES DE STREAMTAPE
// =========================================================
function openModal(id, typeHint, fromDeepLink = false) {
    ...
    // 🔥 CAMBIO CRUCIAL #1: Hacer visible el modal ANTES de inyectar el video
    // Esto evita el error de "tamaño 0x0" (Clickjacking) de Streamtape.
    modal.style.display = 'flex';
...
function setPlayerVideo(url, overlayText = null, isBlocked = false) {
    ...
    if (isDirectFile) {
        ...
        // 🔥 CAMBIO CRUCIAL #2: 0 Sandbox, 0 Restricciones para iframes
        if(isBlocked) {
    ...
    // 🔥 CAMBIO CRUCIAL #3: Solo pintar overlays si ES un archivo mp4 directo.
    // Streamtape no detectará que intentas ponerle cosas encima.
