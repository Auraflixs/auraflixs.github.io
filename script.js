...
function openModal(id, typeHint, fromDeepLink = false) {
    ...
    // 🔥 MODAL VISIBLE PRIMERO (Evita el bloqueo de "0x0 pixels" de Streamtape)
    modal.style.display = 'flex';
...
function setPlayerVideo(url, overlayText = null, isBlocked = false) {
    ...
    if (isDirectFile) {
        ...
        if(isBlocked) {
             ...
             // 🔥 EL SANDBOX "TRAMPA": Permite popups para que Streamtape funcione,
             // pero NO permite 'allow-top-navigation', protegiendo tu página web.
