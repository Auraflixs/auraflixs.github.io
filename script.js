...
// =========================================================
// APERTURA DE MODAL DIRECTA (SIN ANIMACIÓN)
// =========================================================
function openModal(id, typeHint, fromDeepLink = false) {
    ...
    // Mostramos la información del modal
    requestAnimationFrame(() => {
...
function setPlayerVideo(url, overlayText = null, isBlocked = false) {
    ...
    // CORRECCIÓN TRÁILER: Asegurar que los links de YouTube tengan formato embed y aplicarles su sandbox original
    let finalUrl = url;
    ...
    if (isDirectFile) {
        ...
        } else if (overlayText === "Tráiler" || finalUrl.includes('youtube')) {
             // Restauramos el sandbox original SOLO para los tráilers, así YouTube carga normal
...
function closeModalInternal() {
    ...
    }, 50); // Tiempo súper corto para que desaparezca al instante
}
