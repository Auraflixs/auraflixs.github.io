...
window.VIP_SYSTEM_STATUS = "on";     // "on" = Botón de comprar/activar VIP activado | "off" = Oculto
...
document.addEventListener('DOMContentLoaded', () => {
    // Si AMBOS están apagados, ponemos estado libre en el perfil
...
window.isUserVip = function() {
    // Si AMBOS están en "off", no bloqueamos nada (todo libre)
    if (window.VIP_SYSTEM_STATUS === 'off' && window.UNLOCK_LINK_STATUS === 'off') {
        return true; 
    }
